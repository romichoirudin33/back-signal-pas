                            ...
                            <div class="float-right">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="{{ route('user.index', ['jenis'=> 'admin']) }}">User Admin</a>
                                        <a class="dropdown-item" href="{{ route('user.index', ['jenis'=> 'sipir']) }}">User Sipir</a>
                                        <div class="dropdown-divider"></div>
                                        <h6 class="dropdown-header">Export</h6>
                                        <a class="dropdown-item" target="_blank" href="{{ route('user.index', ['export' => 'xls','jenis' => request('jenis')]) }}">
